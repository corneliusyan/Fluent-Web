...
class LectureDetails extends Component {
  ...
  constructor() {
    ...
    this.state = {
      listening: false,
      text: 'I am selfish, impatient and a little insecure. I make mistakes, I am out of control and at times hard to handle. But if you cannot handle me at my worst, then you sure as hell do not deserve me at my best.',
      time: 18,
      par: '',
      elapsed: 0,
      record: mic,
